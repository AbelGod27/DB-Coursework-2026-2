...
- _Backend:_ Node.js con Express.js
- _Base de Datos:_ PostgreSQL (Supabase)
- _Frontend:_ HTML, CSS y JavaScript vanilla (Fetch API)
- _Despliegue:_ Render y GitHub pages
...
- _Frontend:_ HTML5, CSS3 y JavaScript Vanilla (sin frameworks ni bundlers)
- _Backend / Base de Datos:_ Supabase (PostgreSQL + Auth + REST API) con RLS, RPCs, triggers y vistas
- _Realtime:_ Supabase Realtime (WebSocket) con fallback por polling
- _Serverless / Email:_ Vercel Functions (Node.js) + Resend
- _Despliegue:_ Vercel (CI continuo desde GitHub)
